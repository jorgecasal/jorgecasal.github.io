...
const IndexPage = () => (
  <Layout>
    ...
    <section id="banner">
      <header>
        <h2 id="bannerh1">innovating solutions</h2>
      </header>
        <p>
    ...
    <article id="first" className="container box style1 right">
      ...
      <div className="inner">
        ...
        <p>
        A platform where users can create reminders featuring Authorization and authentication.
        </p>
        <a href="https://theremindersapp.herokuapp.com/" target="_blank" rel="noreferrer" className="button style1 ">
            See Live
          </a>
        <a href="https://github.com/jorgecasal/reminderApp" target="_blank" rel="noreferrer" className="button style1 ">
            Source Code
          </a>
      </div>
    </article>
    ...
    <article className="container box style1 left">
      ...
      <div className="inner">
        ...
        <p>
        A fullstack JavaScript app fetching OWM API & Google API to display your locations weather.
        </p>
        <a href="https://geolocationweatherapi.netlify.app/" target="_blank" rel="noreferrer" className="button style1 ">
        See Live
          </a>
        <a href="https://github.com/jorgecasal/weatherAPI" target="_blank" rel="noreferrer" className="button style1 ">
        Source Code
          </a>
      </div>
    </article>
    ...
    <article id="first" className="container box style1 right">
      ...
      <div className="inner">
        ...
        <p>
        A react app that handles GET/POST/PUT/DELETE requests to a database using Redux.        </p>
        <a href="https://post-to-database.herokuapp.com/" target="_blank" rel="noreferrer" className="button style1 ">
            See Live
          </a>
        <a href="https://github.com/jorgecasal/postToDatabase" target="_blank" rel="noreferrer" className="button style1 ">
            Source Code
          </a>
      </div>
    </article>
    ...
    <article className="container box style1 left">
      ...
      <div className="inner">
        ...
        <p>
        A simple but terrific ToDo list that lets you add, edit, and remove items using local storage.
        </p>
        <a href="https://simplest-todo.netlify.app/" target="_blank" rel="noreferrer" className="button style1 ">
            See Live
          </a>
        <a href="https://github.com/jorgecasal/simplest-todo" target="_blank" rel="noreferrer" className="button style1 ">
            Source Code
          </a>
      </div>
    </article>
